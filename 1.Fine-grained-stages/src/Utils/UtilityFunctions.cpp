...
long ADB::UtilityFunctions::genrand_int31() {
  return long(genrand_int32() >> 1);
}
unsigned long ADB::UtilityFunctions::genrand_int32() {
  unsigned long y;
...
ADB::UtilityFunctions::UtilityFunctions() {
 ...
 * @param s
 */
void ADB::UtilityFunctions::init_genrand(unsigned long s) {
  /* initializes mt[N] with a seed */
  mt[0] = s & 0xffffffffUL;
  for (mti = 1; mti < N; mti++) {
    mt[mti] =
 ...
 * @return
 */
double ADB::UtilityFunctions::genrand_real3() {
