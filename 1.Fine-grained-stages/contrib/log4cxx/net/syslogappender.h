...
class LOG4CXX_EXPORT SyslogAppender
...
*/
  inline const LogString &getSyslogHost() const { return syslogHost; }
...
*/
  inline LogString getFacility() const { return getFacilityString(syslogFacility); }
...
*/
  inline void setFacilityPrinting(bool facilityPrinting1) { this->facilityPrinting = facilityPrinting1; }

/**
Returns the value of the <b>FacilityPrinting</b> option.
*/
  inline bool getFacilityPrinting() const { return facilityPrinting; }
