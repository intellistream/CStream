 ...
 */
class LOG4CXX_EXPORT SocketAppenderSkeleton
...
*/
  SocketAppenderSkeleton(helpers::InetAddressPtr
                         address,
                         int port,
                         int reconnectionDelay
  );
...
*/
  inline const LogString &getRemoteHost() const { return remoteHost; }

/**
The <b>Port</b> option takes a positive integer representing
the port where the server is waiting for connections.
*/
  void setPort(int port1) { this->port = port1; }
...
*/
  void setLocationInfo(bool locationInfo1) { this->locationInfo = locationInfo1; }

/**
Returns value of the <b>LocationInfo</b> option.
*/
  bool getLocationInfo() const { return locationInfo; }
...
capability.
*/
  void setReconnectionDelay(int reconnectionDelay1) { this->reconnectionDelay = reconnectionDelay1; }

/**
Returns value of the <b>ReconnectionDelay</b> option.
*/
  int getReconnectionDelay() const { return reconnectionDelay; }
