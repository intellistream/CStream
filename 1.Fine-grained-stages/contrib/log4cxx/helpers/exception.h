...
*/
class LOG4CXX_EXPORT RuntimeException
    : public Exception {
 public:
  RuntimeException(log4cxx_status_t
                   stat);
 ...
 private:
  static LogString formatMessage(log4cxx_status_t
                                 stat);
...
object is required.
*/
class LOG4CXX_EXPORT NullPointerException
...
class LOG4CXX_EXPORT IllegalArgumentException
    : public RuntimeException {
 public:
...
I/O operations.
*/
class LOG4CXX_EXPORT IOException
    : public Exception {
 public:
  IOException();
  IOException(log4cxx_status_t
              stat);
...
class LOG4CXX_EXPORT MissingResourceException
    : public Exception {
 public:
...
class LOG4CXX_EXPORT PoolException
    : public Exception {
 public:
  PoolException(log4cxx_status_t
                stat);
...
class LOG4CXX_EXPORT MutexException
    : public Exception {
 public:
  MutexException(log4cxx_status_t
                 stat);
...
class LOG4CXX_EXPORT InterruptedException
    : public Exception {
 public:
  InterruptedException();
  InterruptedException(log4cxx_status_t
                       stat);
...
class LOG4CXX_EXPORT ThreadException
    : public Exception {
 public:
  ThreadException(log4cxx_status_t
                  stat);
...
class LOG4CXX_EXPORT TranscoderException
    : public Exception {
 public:
  TranscoderException(log4cxx_status_t
                      stat);
...
*/
class LOG4CXX_EXPORT InstantiationException
    : public Exception {
 public:
...
could be found.
*/
class LOG4CXX_EXPORT ClassNotFoundException
    : public Exception {
 public:
...
*/
class LOG4CXX_EXPORT SocketException
    : public IOException {
 public:
  SocketException(const LogString &msg);
  SocketException(log4cxx_status_t
                  status);
...
*/
class LOG4CXX_EXPORT ConnectException
    : public SocketException {
 public:
  ConnectException(log4cxx_status_t
                   status);
  ConnectException(const ConnectException &src);
  ConnectException &operator=(const ConnectException &);
};

class LOG4CXX_EXPORT ClosedChannelException
    : public SocketException {
 public:
...
*/
class LOG4CXX_EXPORT BindException
    : public SocketException {
 public:
  BindException(log4cxx_status_t
                status);
...
*/
class LOG4CXX_EXPORT InterruptedIOException
    : public IOException {
 public:
...
successfully transferred before the interruption occurred.
*/
class LOG4CXX_EXPORT SocketTimeoutException
