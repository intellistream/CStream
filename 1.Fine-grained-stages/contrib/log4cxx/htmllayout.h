...
*/
class LOG4CXX_EXPORT HTMLLayout
    : public Layout {
 private:
...
*/
  inline void setLocationInfo(bool locationInfoFlag) { this->locationInfo = locationInfoFlag; }
...
*/
  inline void setTitle(const LogString &title1) { this->title.assign(title1); }

/**
Returns the current value of the <b>Title</b> option.
*/
  inline const LogString &getTitle() const { return title; }
...
events. Hence, this method return <code>false</code>.  */
  virtual bool ignoresThrowable() const { return false; }
